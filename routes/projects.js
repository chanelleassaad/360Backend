 ...
 *         description: Server error
 */
router.delete("/deleteProject/:id", requireAuths, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 *         description: Server error
 */
router.delete("/deleteVideo/:id", requireAuths, async (req, res) => {
  const { id } = req.params;
 ...
 *         description: Server error
 */
router.delete("/deleteImages/:id", requireAuths, async (req, res) => {
  const { id } = req.params;
 ...
 *         description: Server error
 */
router.put("/editProjectData/:id", requireAuths, async (req, res) => {
  const { id } = req.params;
  const { title, location, year, description } = req.body;
